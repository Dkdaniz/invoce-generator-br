    ...
    <View>
      <View style={pdfUtils.flexRowItemCenter}>
        <View style={{ flex: 1, paddingHorizontal: 40, paddingVertical: 16 }}>
          <Text style={pdfTypography.title}>Descrição</Text>
        </View>
        <View
          style={{
            flex: 1,
        ...
        >
          <View style={{ flex: 1 }}>
            <Text style={pdfTypography.title}>QTDE</Text>
          </View>
          <View style={{ flex: 1 }}>
            <Text style={pdfTypography.title}>Valor</Text>
          </View>
        ...
        <View style={{ flex: 1, paddingTop: 24 }}>
          {note && (
            <View style={{ paddingHorizontal: 40 }}>
              <Text style={pdfTypography.title}>Observação</Text>
